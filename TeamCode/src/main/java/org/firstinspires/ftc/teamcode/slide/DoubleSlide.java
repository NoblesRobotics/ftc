...
public class DoubleSlide {
    ...
    public boolean isBusy() {
        // As long as this is continuously called, it will shut down the motors if they ever get too
        // far apart, otherwise the stuff in between the slides would snap
        if (safetyOn && Math.abs(slideA.getCurrentPosition() - slideB.getCurrentPosition()) > MAX_DIFFERENCE) {
            slideA.setPower(0);
            slideB.setPower(0);
